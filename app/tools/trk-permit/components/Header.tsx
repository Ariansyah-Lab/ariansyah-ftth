      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <button
            ...
            className="flex h-12 w-12 cursor-pointer items-center justify-center rounded-2xl bg-[#dedfe1] text-[#4f5054] shadow-[7px_7px_14px_#bfc0c3,-7px_-7px_14px_#f7f7f8] transition-all duration-200 hover:-translate-y-0.5 hover:text-[#303135] active:translate-y-0 active:shadow-[inset_4px_4px_8px_#bfc0c3,inset_-4px_-4px_8px_#f7f7f8]"
          >
